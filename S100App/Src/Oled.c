...
#ifdef SSD1316
u8 gOled_param[50] = {  0x80,0xAE,0x80,0x00,0x80,0x10,
                        0x80,0x40,0x80,0xB0,0x80,0x81,
                        0x80,0xFF,0x80,0xA0,0x80,0xA6,0x80,0xA8,0x80,0x1F,
...
/*
u8 gOled_paramL[46] = { 0x80,0xAE,0x80,0xD5,0x80,0x52,0x80,0xA8,0x80,0x0f,0x80,
...
if (Get_LeftHandedFlag() == 1)  
{
      gOled_param[12-1]=0xC8;
      gOled_param[20-1]=0xA1;
} 
...
//        Print_Integer(Get_LeftHandedFlag()+48,0);
//        Delay_Ms(2000);
//        Clear_Watchdog();
