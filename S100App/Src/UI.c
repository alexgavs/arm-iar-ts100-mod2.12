...
//
//static u8 Ver_s_orig[] = {  /*12*16*/
//    0x04,0x0C,0x74,0x80,0x00,0x00,0x00,0x80,0x74,0x0C,0x04,0x00,0x00,0x00,0x00,0x03,0x1C,0x60,0x1C,0x03,0x00,0x00,0x00,0x00,/*"V",0*/
//    0x00,0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x00,0x00,0x00,0x1F,0x22,0x42,0x42,0x42,0x42,0x22,0x13,0x00,0x00,0x00,/*"e",1*/
//    0x00,0x40,0x40,0xC0,0x00,0x80,0x40,0x40,0x40,0xC0,0x00,0x00,0x00,0x40,0x40,0x7F,0x41,0x40,0x40,0x00,0x00,0x00,0x00,0x00,/*"r",2*/
//    0x00,0x00,0x00,0x00,0x60,0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x60,0x60,0x00,0x00,0x00,0x00,0x00,0x00,/*":",3*/
//    0x00,0x78,0x04,0x04,0x04,0x04,0x04,0x88,0x78,0x00,0x00,0x00,0x00,0x60,0x50,0x48,0x44,0x42,0x41,0x40,0x70,0x00,0x00,0x00,/*"2",4*/
//    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x60,0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,/*".",5*/
//    0x00,0xE0,0x18,0x08,0x04,0x04,0x04,0x08,0x18,0xE0,0x00,0x00,0x00,0x0F,0x30,0x20,0x40,0x40,0x40,0x20,0x30,0x0F,0x00,0x00,/*"0",6*/
//    0x00,0x00,0x00,0x08,0x08,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x40,0x7F,0x40,0x40,0x40,0x00,0x00,0x00,/*"1",7*/
...
0x04,0xFC,0x1C,0xF0,0x80,0x00,0x00,0xC0,0x30,0xFC,0xFC,0x04,0x20,0x3F,0x20,0x00,0x07,0x3C,0x0E,0x01,0x20,0x3F,0x3F,0x20,/*"M",0*/
0x00,0x00,0x80,0x40,0x40,0x40,0x40,0x40,0xC0,0x80,0x00,0x00,0x00,0x0F,0x1F,0x30,0x20,0x20,0x20,0x20,0x20,0x1B,0x0F,0x00,/*"o",1*/
0x00,0x00,0x80,0x40,0x40,0x40,0x40,0x48,0xFC,0xFC,0x00,0x00,0x00,0x0F,0x18,0x20,0x20,0x20,0x20,0x20,0x3F,0x3F,0x20,0x00,/*"d",2*/
0x00,0x00,0x00,0x00,0x00,0xC0,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x30,0x00,0x00,0x00,0x00,0x00,/*":",3*/
0x00,0x00,0x18,0x08,0x04,0x84,0x84,0xC4,0x38,0x00,0x00,0x00,0x00,0x00,0x20,0x20,0x21,0x20,0x20,0x21,0x11,0x0F,0x00,0x00,/*"3",4*/
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x30,0x00,0x00,0x00,0x00,0x00,/*".",5*/
0x00,0xE0,0x70,0x08,0x04,0x04,0x04,0x04,0x08,0x70,0xE0,0x00,0x00,0x07,0x1E,0x30,0x20,0x20,0x20,0x20,0x30,0x1E,0x07,0x00,/*"0",6*/
0x00,0xE0,0x70,0x08,0x04,0x04,0x04,0x04,0x08,0x70,0xE0,0x00,0x00,0x07,0x1E,0x30,0x20,0x20,0x20,0x20,0x30,0x1E,0x07,0x00,/*"0",7*/
};
...
//0x30=48=(0);  0x3a=58 (:) , 57=9
    ...
    for(i = 0; i < fnt_size*2; i++) {
        Ver_s[4 * fnt_size*2 + i] = Number12[temp0 * fnt_size*2 + i];
        Ver_s[6 * fnt_size*2 + i] = Number12[temp1 * fnt_size*2 + i];
        Ver_s[7 * fnt_size*2 + i] = Number12[temp2 * fnt_size*2 + i];
    }

    for(k = 0; k < fnt_size_y; k++) {
        if(flag == 0) {
            Show_ReverseChar((u8*)Ver_s,8,fnt_size,2);
            ptr = (u8*)gTemp_array;
        } else {
            ptr = (u8*)Ver_s;
        }
        for(i = 0; i < 8; i++) {
            ptr = Oled_DrawArea(i*fnt_size,0,fnt_size,fnt_size_y,ptr);
        }
    }
    if(flag == 0) {
        Delay_Ms(1000);
...
void Display_Str45(u8 x, char* str)
{
    u8* ptr;
    u8 temp;
    u8 position = 0;
    ...
    ptr = (u8*)Number8r;
        ptr += temp*(fsx);
        Oled_DrawArea(x + position*fsx,0,fsx,fsy,(u8*)ptr);
        position++;
    }
}
